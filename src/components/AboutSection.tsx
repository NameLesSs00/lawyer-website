          ...
          >
            ...
            <div className="space-y-6">
              ...
              <p className="text-white/80 text-lg leading-relaxed">
                إذا كنت تبحث عن <strong>محامي في الغردقة</strong> أو <strong>محامي في البحر الأحمر</strong> يتمتع بالخبرة والنزاهة، فإن مكتب الأستاذ ميلاد يعقوب بولس هو وجهتك المثالية. نحن نضع مصلحة الموكل في المقام الأول ونعمل بجدية لضمان استعادة الحقوق وفق أحدث المنظومات القانونية في كافة المحاكم المصرية.
              </p>
