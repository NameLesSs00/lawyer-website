...
import { FileText, Newspaper, LogOut, Plus, Edit, Trash2, X } from "lucide-react";
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                {pdfs.map(item => (
                  <div key={item.id} className="border border-border p-4 rounded-xl shadow-sm relative group bg-card hover:border-gold/50 transition-colors">
                    ...
                    <span className="text-[10px] bg-gold/10 text-black px-2 py-1 rounded font-bold inline-block mb-3">
                      {item.category}
                    </span>
